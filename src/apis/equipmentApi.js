...
const equipmentApi = {
  ...
  update: async (id, equipmentData) => {
    ...
    if (equipmentData.name) formData.append('name', equipmentData.name);
    if (equipmentData.category) formData.append('category', equipmentData.category);
    if (equipmentData.description) formData.append('description', equipmentData.description);
    if (equipmentData.application) formData.append('application', equipmentData.application);
